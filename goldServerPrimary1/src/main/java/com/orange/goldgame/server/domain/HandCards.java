...
public class HandCards implements Comparable<HandCards>{
    ...
    public static void main(String[] args){
        ...
        Card a1 = new Card(CardColour.HEARTS,CardValue.KING);
        Card a2 = new Card(CardColour.HEARTS,CardValue.ACE);
        Card a3 = new Card(CardColour.HEARTS,CardValue.TWO);
        ...
        Card b1 = new Card(CardColour.PLUM,CardValue.QUEEN);
        Card b2 = new Card(CardColour.PLUM,CardValue.NINE);
        Card b3 = new Card(CardColour.PLUM,CardValue.FOUR);
        cardsb[0] = b1;
        cardsb[1] = b2;
        cardsb[2] = b3;
