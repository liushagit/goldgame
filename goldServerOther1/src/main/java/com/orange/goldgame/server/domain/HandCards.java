...
public class HandCards implements Comparable<HandCards>{
    ...
    public static void main(String[] args){
        ...
        Card a1 = new Card(CardColour.SPADES,CardValue.KING);
        Card a2 = new Card(CardColour.SPADES,CardValue.QUEEN);
        Card a3 = new Card(CardColour.SPADES,CardValue.TWO);
        ...
        Card b1 = new Card(CardColour.DIAMOND,CardValue.QUEEN);
        Card b2 = new Card(CardColour.HEARTS,CardValue.QUEEN);
