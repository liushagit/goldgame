...
//        Container.registerServer("mmPayService", new MMPayService());
        ...
        Container.registerServerPath(""+Protocol.REQUEST_ADD_GOLD_COPPER, "adminServer/addGoldOrStone");
        Container.registerServerPath(""+Protocol.REQUEST_QUERY_PAY_LIST, "adminServer/checkPayForPlayer");
        Container.registerServerPath(""+Protocol.REQUEST_QUERY_GOLD_COPPER, "adminServer/queryPlayRich");
