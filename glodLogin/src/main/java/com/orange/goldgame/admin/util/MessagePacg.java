...
public class MessagePacg {
	...
	public short end = 2000;
	public short head = 1000;
    ...
    public void putMsgHead()
    {
   	 check_NUM += head;
   	 this.msgLen += 2;
    	 msgData[inc++] = (byte) (( head >>> 8) & 0xFF);
   	 msgData[inc++] = (byte) ( head & 0xFF);
    }
    ...
    {
   	 if(getMsgHead() !=  head) return false;
   	 return true;
    }
...
//    }
    ...
    {
//   	 check_NUM +=  ComandConfig.msg_end;
   	 msgData[inc++] = (byte) ((end >>> 8) & 0xFF);
   	 msgData[inc++] = (byte) (end & 0xFF);
   	 this.msgLen = (short) getInc();
//   	 data = new int[getInc()-2]; 
//   	 for(int i=8;i<getInc()-2;i++){
//   		 data[i] = msgData[i];
...
//   	 putCheck_NUM(check_NUM);
    ...
    {
   	 if(getMSG_END() != end) return false;
   	 return true;
    }
