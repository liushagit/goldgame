...
public class Constants {
     ...
     * 禁言
     */
    public static final int PLAYER_STATUS_BAN = 2;
	...
	/**疯狂豹子王MM计费7->133**/
	public static final byte MM_FENGKUANG_BAOZIWANG=8;
	public static final int MM_FENGKUANG_BAOZIWANG_NUM=135;
	
	/**土豪MM弱联网计费1->128**/
	public static final byte MM_TUHAO_RUO=9;
	public static final int MM_TUHAO_NUM_RUO=136;
	/**欢乐扑克王弱联网计费1->128**/
	public static final byte MM_HUANLE_RUO=10;
	public static final int MM_HUANLE_NUM_RUO=140;
	
	/**真人扑克王弱联网计费1->128**/
	public static final byte MM_ZHENREN_RUO=11;
	public static final int MM_ZHENREN_NUM_RUO=141;
	/****************移动MM计费结束**************************/
