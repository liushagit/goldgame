...
import com.orange.http.HttpWeiMiPayHandler;
import com.orange.http.HttpWheelRecoderHandler;
...
public class ProxyServerBootstrap {
	...
	public static void main(String[] args) throws Exception {
		...
		serverManager.registerHandler("wheel", new HttpWheelRecoderHandler());
		serverManager.registerHandler("wimipay", new HttpWeiMiPayHandler());
