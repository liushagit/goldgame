...
public abstract class Message {
	...
	/** 微米支付通知 **/
	public static final String WEIMI_PROTOCOL = "-2003";
	
	/** 抽奖  **/
	public static final String WHEEL_PROTOCOL= "-2004";
	...
	public static final int RESPONSE_WEIMI_PROTOCOL= -5003;
	
	/** 抽奖  **/
	public static final int RESPONSE_WHEEL_PROTOCOL= -5004;
