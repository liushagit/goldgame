...
public class Protocol {
	...
	/** 6112 请求修改玩家道具 **/
	public static final short REQUEST_ADD_PROP = 6112;
	/** 6113通过日期筛选玩家充值记录 **/
	public static final short REQUEST_PAY_LSIT_BY_PLAYER = 6113;
	/** 6114查看玩家支付宝充值记录 **/
	public static final short REQUEST_PAY_ZFB_BY_PLAYER = 6114;
	/** 6115请求公告列表 **/
	public static final short REQUEST_NOTICE_LIST = 6115;
	/** 6116请求添加新公告 **/
	public static final short REQUEST_ADD_NEW_NOTICE = 6116;
	/** 6117请求修改新公告 **/
	public static final short REQUEST_UPDATE_NEW_NOTICE = 6117;
	/** 6118请求删除新公告 **/
	public static final short REQUEST_DELETE_NEW_NOTICE = 6118;
	/** 6119请求发送消息列表 **/
	public static final short REQUEST_SEND_MESSAGE_LIST = 6119;
	/** 6120请求添加新消息 **/
	public static final short REQUEST_ADD_SEND_MESSAGE = 6120;
	/** 6121请求修改消息 **/
	public static final short REQUEST_UPDATE_SEND_MESSAGE = 6121;
	/** 6122请求删除消息 **/
	public static final short REQUEST_DELETE_SEND_MESSAGE = 6122;
	/** 6123请求玩家消费记录 **/
	public static final short REQUEST_PLAYER_CONSUME_RECORD = 6123;
	...
	/** 6912 返回修改玩家道具结果 **/
	public static final short RESPONSE_ADD_PROP = 6912;
	/** 6913通过日期筛选玩家充值记录 **/
	public static final short RESPONSE_PAY_LSIT_BY_PLAYER = 6913;
	/** 6914返回玩家支付宝充值记录 **/
	public static final short RESPONSE_PAY_ZFB_BY_PLAYER = 6914;
	/** 6915返回请求公告列表 **/
	public static final short RESPONSE_NOTICE_LIST = 6915;
	/** 6916返回操作结果信息->多用 **/
	public static final short RESPONSE_COMMON_TIP_MESSAGE = 6916;
	/** 6919返回发送消息列表 **/
	public static final short RESPONSE_SEND_MESSAGE_LIST = 6919;
	/** 6923返回玩家消费记录 **/
	public static final short RESPONSE_PLAYER_CONSUME_RECORD = 6923;
	/*********************** 管理员端口相关协议 *************************/
    ...
    /************************* 情人功能协议开始 **********************************/
    //---- 客户端请求增加情人，初中高比赛 ----/
    public static final short REQUEST_PRIMY_ADDLOVER = 1135;
    public static final short REQUEST_MIDDLE_ADDLOVER = 2135;
    public static final short REQUEST_HEIGH_ADDLOVER = 3135;
    public static final short REQUEST_MATCH_ADDLOVER = 4135;
    //---- 服务端响应增加情人 ----/
    public static final short RESPONSE_ADDLOVER = 5020;
    
    //---- 客户端请求删除情人，初中高比赛 ----/
    public static final short REQUEST_PRIMY_DELETELOVER = 1136;
    public static final short REQUEST_MIDDLE_DELETELOVER = 2136;
    public static final short REQUEST_HEIGH_DELETELOVER = 3136;
    public static final short REQUEST_MATCH_DELETELOVER = 4136;
    //---- 服务端响应删除情人 ----/
    public static final short RESPONSE_DELETELOVER = 5020;
    
    //---- 客户端请求某个玩家聊天内容 ----/
    public static final short REQUEST_LOVERMESSAGE = 1132;
    //---- 服务端响应聊天内容 ----/
    public static final short RESPONSE_LOVERMESSAGE = 5129;
    public static final short RESPONSE_LOVERMESSAGE_SENDER = 5130;
    public static final short RESPONSE_CPA_ACTIVITY = 5142;
    
    //---- 客户端请求某个玩家聊天内容 ----/
    public static final short REQUEST_SENDMESSAGE = 1133;
    
    //------ 九十二、客户端请求发送查看邀请人信息的协议 -----/
    public static final short REQUEST_PRIMY_LOVERINFO = 1137;
    public static final short REQUEST_MIDDLE_LOVERINFO = 2137;
    public static final short REQUEST_HEIGH_LOVERINFO = 3137;
    public static final short REQUEST_MATCH_LOVERINFO = 4137;
    //---- 九十三、服务端返回邀请人信息协议 ----/
    public static final short RESPONSE_LOVERINFO = 5131;
    //------ 九十四、客户端请求发送同意/拒绝成为情人协议 -----/
    public static final short REQUEST_PRIMY_HANDLELOVER = 1138;
    public static final short REQUEST_MIDDLE_HANDLELOVER = 2138;
    public static final short REQUEST_HEIGH_HANDLELOVER = 3138;
    public static final short REQUEST_MATCH_HANDLELOVER = 4138;
    
    
    
    //---------- 新支付方式------------------------//
    public static final short REQUEST_CREATE_PAY_ORDER = 1141;
    //---- 九十三、服务端返回邀请人信息协议 ----/
    public static final short RESPONSE_CREATE_PAY_ORDER = 5134;
    public static final short REQUEST_PAYINFO = 4139;
    public static final short RESPONSE_PAYINFO = 5143;
    public static final short RESPONSE_WHEELNUM = 5144;
    ...
    /************************* 帮助功能协议开始 **********************************/
    //--------------- 九十五、客户端请求帮助协议 ------------//
    public static final short REQUEST_HELPTYPE = 1139;
    //--------------- 九十六、服务端返回帮助内容协议 ------------//
    public static final short RESPONSE_HELPTYPE = 5132;
    ...
    /************************* 大转盘开始 **********************************/
    //--------------- 一○一、客户端请求进入幸运抽奖界面 ------------//
    public static final short REQUEST_WHEEL = 1143;
    //--------------- 一○二、服务端返回转盘抽奖内容------------//
    public static final short RESPONSE_WHEEL = 5136;
    
    public static final short REQUEST_WEIMIPAY = -2003;
    public static final short RESPONS_WEIMIPAY = -5003;
    //--------------- 一○三、客户端请求点击抽奖 ------------//
    public static final short REQUEST_WHEEL_CHECKTODAY = 1145;
    public static final short RESPONSE_WHEEL_CHECKTODAY = 5137;

    //------------------ 获取购买抽奖卷列表 -----------------------//
    public static final short REQUEST_WHEEL_PAYLIST = 1150;
    public static final short RESPONSE_WHEEL_PAYLIST = 5141;
    
    
    //--------------- 一○五、客户端请求确定抽奖------------//
    public static final short REQUEST_WHEEL_LOTTERY = 1147;
    public static final short RESPONSE_WHEEL_LOTTERY = 5138;
    
    public static final short RESPONSE_WHEEL_MESSAGE = 5140;
    
    public static final short REQUEST_WHEEL_LEAVEMESSAGE = 1146;
    public static final short REQUEST_WHEEL_LEAVEWHEEL = 1148;
    public static final short REQUEST_WHEEL_SELFMESSAGE = 1149;
    public static final short REQUEST_WHEEL_ADMIN = -2004;
    public static final short RESPONSE_WHEEL_ADMIN = -5004;
    /************************* 大转盘结束 **********************************/
