...
public class CleanTask{
	...
	private synchronized void addRobotPlayer(GameTable table,GameRoom room){
	    try{
    	    Gamer robot = null;
            ...
            if (player.getCopper() == null || player.getCopper() <= config.getLimitGolds()) {
                if (player.getCopper() <= 0) {
                    ...
                    player.setCopper(config2.getLimitGolds()+(rd.nextInt(5)+1)*10000);
            ...
            robot.setLeftGolds(player.getCopper());
