...
//        Container.registerServerPath(""+Protocol.REQUEST_SEAL, "adminServer/sealAccount");
		...
		Container.registerServerPath(""+Protocol.REQUEST_PRIMY_ADDLOVER, "loverServer/addLover");
		Container.registerServerPath(""+Protocol.REQUEST_MIDDLE_ADDLOVER, "loverServer/addLover");
		Container.registerServerPath(""+Protocol.REQUEST_HEIGH_ADDLOVER, "loverServer/addLover");
		
		Container.registerServerPath(""+Protocol.REQUEST_PRIMY_DELETELOVER, "loverServer/deleteLover");
		Container.registerServerPath(""+Protocol.REQUEST_MIDDLE_DELETELOVER, "loverServer/deleteLover");
		Container.registerServerPath(""+Protocol.REQUEST_HEIGH_DELETELOVER, "loverServer/deleteLover");
		
		Container.registerServerPath(""+Protocol.REQUEST_PRIMY_LOVERINFO, "loverServer/loverInfo");
		Container.registerServerPath(""+Protocol.REQUEST_MIDDLE_LOVERINFO, "loverServer/loverInfo");
		Container.registerServerPath(""+Protocol.REQUEST_HEIGH_LOVERINFO, "loverServer/loverInfo");
        
		Container.registerServerPath(""+Protocol.REQUEST_PRIMY_HANDLELOVER, "loverServer/handleLover");
		Container.registerServerPath(""+Protocol.REQUEST_MIDDLE_HANDLELOVER, "loverServer/handleLover");
		Container.registerServerPath(""+Protocol.REQUEST_HEIGH_HANDLELOVER, "loverServer/handleLover");
