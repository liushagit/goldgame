...
public class GiftService {
    ...
    public Gift getPlayerGift(Player player,int giftId){
        Gift gift = getGiftMap(player,false).get(giftId);
        return gift;
    }
    public void reloadPlayerGift(Player player){
    	getGiftMap(player,true);
    }
}
