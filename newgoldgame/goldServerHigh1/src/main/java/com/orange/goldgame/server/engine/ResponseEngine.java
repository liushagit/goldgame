    ...
    public static void personalItemListResponse(SocketResponse response,
        ...
        if (personalItemList != null&&personalItemList.size()>0) {
        	for(PlayerProps playerProps :personalItemList){
        		...
        		//TODO test
    			sb.append("propsConfigid==").append(propsConfig.getId());
    			sb.append("propsConfigType==").append(propsConfig.getPropsType());
    			sb.append("propsConfigName==").append(propsConfig.getName());
    			sb.append("playerPropsNumber==").append(playerProps.getNumber());
        	}
		}
