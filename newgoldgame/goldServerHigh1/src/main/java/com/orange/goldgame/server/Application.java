...
//        Container.registerServerPath(""+Protocol.REQUEST_SEAL, "adminServer/sealAccount");
		...
		Container.registerServerPath(""+Protocol.REQUEST_MATCH_ADDLOVER, "loverServer/addLover");
		Container.registerServerPath(""+Protocol.REQUEST_MATCH_DELETELOVER, "loverServer/deleteLover");
		Container.registerServerPath(""+Protocol.REQUEST_MATCH_LOVERINFO, "loverServer/loverInfo");
		Container.registerServerPath(""+Protocol.REQUEST_MATCH_HANDLELOVER, "loverServer/handleLover");
