package com.orange.game.china.mobile.market.utils;
...
public class HttpUtil {
	...
	public static byte[] post(String url, RequestEntity requestEntity) throws Exception {
        ...
        /*logger.info("contentlength:" + requestEntity.getContentLength());
        method.setRequestContentLength(requestEntity.getContentLength());
        method.setRequestHeader("Content-Length", String.valueOf(requestEntity.getContentLength()));*/
